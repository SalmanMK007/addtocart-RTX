...
// import "./cartstyle.css"
// import { useDispatch, useSelector } from 'react-redux';
// import { addToCart,removeToCart } from '../redux/features/cartSilce';
...
//         <>
//             <div className="row justify-content-center m-0">
//                 <div className="col-md-8 mt-5 md-5 cardsdetails">
//                     <div className="card">
//                         <div className="card-header bg-dark p-3">
//                             <div className='card-header-flex'>
//                                 <h5 className='text-white m-0'>Cart Calculation {carts.length >0 ? `(${carts.length})`:""}</h5>
//                                 {
//                                     carts.length > 0 ? <button className='btn btn-danger mt-0 btn-sm'><i className='fa fa-trash-alt mr-2'></i><span>EmptyCart</span> </button>
//                                         : ""
//                                 }
//                             </div>
//                         </div>
...
//                                                 <th className='text-right'>Total Price<span className='ml-2 mr-2'>:</span><span className='text-danger'>₹ 9999</span></th>
//                                                 {/* <th>Items In Cart <span className='ml-2 mr-2'>:</span><span className='text-danger'>{totalquantity}</span></th> */}
//                                                 {/* <th className='text-right'>Total Price<span className='ml-2 mr-2'>:</span><span className='text-danger'>₹ {totalprice}</span></th> */}
//                                             </tr>
//                                         </tfoot>
